...
curl -o "C:\Users\Public\Desktop\idman641build2.exe" https://raw.githubusercontent.com/MuhamadMtrosymuhamad/RDP_FREE-2022/main/idman641build2.exe > out.txt 2>&1
